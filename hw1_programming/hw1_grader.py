...
grader.addHiddenPart('3g-4-hidden', lambda : test3g(5, 20), maxPoints=1, maxSeconds=20, description='random trials')
grader.addHiddenPart('3g-5-hidden', lambda : test3g(5, 400), maxPoints=1, maxSeconds=10000, description='random trials (longer)')
